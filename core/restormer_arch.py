...
##
## Copied directly from models/Restormer/basicsr/models/archs/restormer_arch.py
## to bypass BasicSR compilation (no C++ extensions needed for inference).
## Only dependency: torch, einops
